...
double delta(double measuredMass, double countedMass,
  ...
  if (strcmp(units, "ppm") == 0)
    ...
    printf("Unknown units for delta!");
  return false;
}
...
// call the template metaprogramming
{
  ...
  switch (elcount) {
    case 1:
      formula_generator<1>::EXEC(p_result, elcount, minimum, maximum, masses,
                                 current, pre_mass, loMass, hiMass, k);
      break;
    case 2:
      formula_generator<2>::EXEC(p_result, elcount, minimum, maximum, masses,
                                 current, pre_mass, loMass, hiMass, k);
      break;
    case 3:
      formula_generator<3>::EXEC(p_result, elcount, minimum, maximum, masses,
                                 current, pre_mass, loMass, hiMass, k);
      break;
    case 4:
      formula_generator<4>::EXEC(p_result, elcount, minimum, maximum, masses,
                                 current, pre_mass, loMass, hiMass, k);
      break;
    case 5:
      formula_generator<5>::EXEC(p_result, elcount, minimum, maximum, masses,
                                 current, pre_mass, loMass, hiMass, k);
      break;
    case 6:
      formula_generator<6>::EXEC(p_result, elcount, minimum, maximum, masses,
                                 current, pre_mass, loMass, hiMass, k);
      break;
    case 7:
      formula_generator<7>::EXEC(p_result, elcount, minimum, maximum, masses,
                                 current, pre_mass, loMass, hiMass, k);
      break;
    case 8:
      formula_generator<8>::EXEC(p_result, elcount, minimum, maximum, masses,
                                 current, pre_mass, loMass, hiMass, k);
      break;
    case 9:
      formula_generator<9>::EXEC(p_result, elcount, minimum, maximum, masses,
                                 current, pre_mass, loMass, hiMass, k);
      break;
    case 10:
      formula_generator<10>::EXEC(p_result, elcount, minimum, maximum, masses,
                                  current, pre_mass, loMass, hiMass, k);
      break;
    case 11:
      formula_generator<11>::EXEC(p_result, elcount, minimum, maximum, masses,
                                  current, pre_mass, loMass, hiMass, k);
      break;
    case 12:
      formula_generator<12>::EXEC(p_result, elcount, minimum, maximum, masses,
                                  current, pre_mass, loMass, hiMass, k);
      break;
    case 13:
      formula_generator<13>::EXEC(p_result, elcount, minimum, maximum, masses,
                                  current, pre_mass, loMass, hiMass, k);
      break;
    case 14:
      formula_generator<14>::EXEC(p_result, elcount, minimum, maximum, masses,
                                  current, pre_mass, loMass, hiMass, k);
      break;
    case 15:
      formula_generator<15>::EXEC(p_result, elcount, minimum, maximum, masses,
                                  current, pre_mass, loMass, hiMass, k);
      break;
    default:
      break;
...
void calculation(double currentmass, vector<char *> compositions,
                 ...
                 float tolerance, int charge, const char *agentformula,
                 int agentcharge, const char *units) {
  ...
  double pre_mass = 0.0;
  PFG(p_result, elcount, mincount, maxcount, _elmass, current, pre_mass, loMass,
      hiMass);
  ...
  for (int i = 0; i < p_result->len; i++) {
    ...
    int t = frules(temp, countC, countH, countO, countN, countP, countS,
                   rdbevalue, rules);
    if (t == 1) {
